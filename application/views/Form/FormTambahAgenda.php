<div class="container">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Form Tambah Agenda</h1>
    <hr style="border: 0.2px solid grey;">
    <form action="<?php echo base_url() ?>ControllersDataAgenda/TambahData" method="POST">
        <label for="nama_acara" id="nama_acara" class="form-label">Nama Acara</label>
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1"><i class="far fa-calendar-alt"></i></span>
            <input type="text" class="form-control" id="nama_acara" name="nama_acara" required oninvalid="this.setCustomValidity('Nama Acara Tidak Boleh Kosong')" oninput="setCustomValidity('')">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="time" class="form-control" id="jam_acara" name="jam_acara" required oninvalid="this.setCustomValidity('Jam Acara Tidak Boleh Kosong')" oninput="setCustomValidity('')">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="date" class="form-control" id="tanggal_acara" name="tanggal_acara" required oninvalid="this.setCustomValidity('Tanggal Acara Tidak Boleh Kosong')" oninput="setCustomValidity('')">
        </div>

        <label for="penanggung_jawab" class="form-label">Penanggung Jawab</label>
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon4"><i class="fas fa-user"></i></span>
            <input type="text" class="form-control" id="penanggung_jawab" name="penanggung_jawab" required oninvalid="this.setCustomValidity('Penanggung Jawab Tidak Boleh Kosong')" oninput="setCustomValidity('')">
        </div>
